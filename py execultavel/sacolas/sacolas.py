...
lista_coladores = list(df_colador['nome'])
lista_coladores.insert(0,"")
lista_os = list(df_os['OS'])
lista_os.insert(0,"")

#tratando os dados das tabelas

#df_completo = pd.concat([df_os,df_dados])
...
#essa parte precisou entrar na função para que assim ela seja execultada
#entry_descricao = Label(frame_pesquisa,font=('arial',10),text=f"uma descrição aqui",
#                       fg=branca, bg=verde_escuro,anchor=NE )
#entry_descricao.place(x=330, y=25)
...
entry_colador['value'] = lista_coladores
